...
约束：
- 不要输出 Markdown 或代码块。
- requestedTools 只能从 get_code_graph_status、get_memory_snapshot、search_memory_facts、get_changed_files、get_file_context、get_call_graph_neighbors、get_related_review_history、get_architecture_summary、rebuild_code_graph、run_additional_review_agents 中选择。
