 ...
 */
export async function createReviewStream(opts: { session: SessionWithRepository; messages: UIMessage[]; abortSignal?: AbortSignal }) {
  ...
  return { stream, ctx, blueprint, runtimeMemory, verifierModel: resolveModel(modelConfigs.verifier), verifierConfig: modelConfigs.verifier };
}
