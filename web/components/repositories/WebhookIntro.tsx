...
export function WebhookIntro({ webhookUrl, onAdd }: { webhookUrl: string; onAdd: () => void }) {
  return (
    <ColorBlock tone="lime" className="space-y-4 p-5">
      ...
      <code className="block break-all rounded-[var(--r-md)] border border-[var(--line-invert)] bg-[var(--surface-dark)] px-3 py-2.5 font-mono text-xs text-[var(--brand-mint)]">{webhookUrl}</code>
