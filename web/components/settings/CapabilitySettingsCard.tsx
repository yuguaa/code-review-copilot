...
export function CapabilitySettingsCard({
  tools,
  skills,
  enabledTools,
  enabledSkills,
  ...
  return (
    <Card className="space-y-4">
      ...
      <CapabilityList title="Tools 默认启用" items={tools} selected={enabledTools} onChange={onToolsChange} />
      <CapabilityList title="Skills 默认启用" items={skills} selected={enabledSkills} onChange={onSkillsChange} />
